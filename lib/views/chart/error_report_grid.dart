...
class ErrorReportDataGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<ElectricityDataDashboardViewModel>(
      builder: (context, electricityDataDashboardViewModel, child) => SfDataGrid(
        //footer: Spacer(),
        ...
        source: AmmeterGridDataSource(
            dataSource: electricityDataDashboardViewModel.ammeterErrorReportList
        ),
        columns: [
          GridColumn(columnName: '設備編號', label: Container(
          ...
          GridColumn(columnName: '設備名稱', label: Container(
            color: DashboardColor.surfaceVariant(context).withOpacity(0.3),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
          ...
          GridColumn(columnName: '開始時間', label: Container(
            color: DashboardColor.surfaceVariant(context).withOpacity(0.3),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
          ...
          GridColumn(columnName: '正常邊界', label: Container(
            color: DashboardColor.surfaceVariant(context).withOpacity(0.3),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
          ...
          GridColumn(columnName: '異常數值', label: Container(
            color: DashboardColor.surfaceVariant(context).withOpacity(0.3),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
          ...
          GridColumn(columnName: '異常狀態', label: Container(
            color: DashboardColor.surfaceVariant(context).withOpacity(0.3),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
